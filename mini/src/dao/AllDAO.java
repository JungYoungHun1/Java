...
public class AllDAO {
	...
	public static ArrayList<RentalinfoDTO> getrentalinfo() throws SQLException, NotExistException {
		...
		try {
			...
			while (rset.next()) {
				list.add(new RentalinfoDTO(rset.getInt(1), rset.getString(2), rset.getString(3), rset.getInt(4),
						rset.getInt(5)));
	...
	//////////////////////// 밑으로 용주 Dao /////////////////////////////
	///////////////////////////// 플래그 확인 함수 //////////////////////////
	public static boolean flagReturn(int bookId) throws SQLException, NotExistException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		ArrayList<BookDTO> list = null;
	...
	public static boolean borrowBooks(int userId, int bookId) throws SQLException, NotExistException {
		...
		try {
			...
			pstmt = con.prepareStatement(
					"insert into rental_info(borrow_day,return_day,id_number,book_number) values(curdate(),adddate(curdate(), 10),?,?)");
